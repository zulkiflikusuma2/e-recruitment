...
@section('title', 'Tes Praktek | CBI')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="/practiceattend">Laporan Kehadiran Seleksi Praktik</a></li>
@endsection
...
@section('container')
    ...
    <ul class="nav nav-pills">
        ...
        <li><a href="/practiceattend" class="nav-link active">Tes Praktik</a>
        </li>
    ...
    <div class="table-responsive">
        <table id="practiceattend" class="table table-striped table-bordered zero-configuration" style="border: 1">
            <thead>
                <tr align="center">
                    <th>No</th>
                    <th>Nama</th>
            ...
            $('#practiceattend').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'PDF',
                        download: 'open',
                        messageTop: 'Berikut data kehadiran seleksi praktik:',
