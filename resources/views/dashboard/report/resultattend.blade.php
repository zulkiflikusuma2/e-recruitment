...
@section('title', 'Kehadiran | CBI')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="/resultattend">Laporan Kehadiran Agenda Penerimaan</a></li>
@endsection

@section('container')
    <div class="card-header">
        <h5 class="mb-5 font-weight-bold text-primary" style="text-align: center">Laporan Kehadiran</h5>
    </div>
    <ul class="nav nav-pills">
        <li><a href="/writtenattend" class="nav-link">Psikotes</a>
        </li>
        <li><a href="/practiceattend" class="nav-link">Psikotes</a>
        </li>
        <li><a href="/interviewattend" class="nav-link">Wawancara</a>
        </li>
        <li><a href="/resultattend" class="nav-link active">Agenda Penerimaan</a>
        </li>
    </ul>

    <div class="table-responsive">
        <table id="resultattend" class="table table-striped table-bordered zero-configuration" style="border: 1">
            <thead>
                <tr align="center">
                    <th>No</th>
                    <th>Nama</th>
            ...
            <tbody>
                @foreach ($applicants as $applicant)
                    <tr align="center">
                        ...
                        <td>{{ Carbon\Carbon::parse($applicant->date)->format('d/m/Y') }} -
                            {{ Carbon\Carbon::parse($applicant->time)->format('G.i') }}</td>
                        <td>
            ...
            $('#resultattend').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'PDF',
                        download: 'open',
                        messageTop: 'Berikut data kehadiran agenda penerimaan pegawai:',
                                    ...
                                    columns: [{
                                        ...
                                        },
                                        {
                                            ...
                                            text: [
                                                ...
                                                'Telp: (62-21) 29488812\n',
                                                'email: contact@incoe.astra.co.id'
