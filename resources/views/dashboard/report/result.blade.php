...
@section('title', 'Hasil | CBI')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
    <li class="breadcrumb-item active"><a href="/activevacancies/">Laporan Hasil Seleksi</a></li>
@endsection
...
@section('container')
    ...
    <div class="card-header">
        <h5 class="m-0 font-weight-bold text-primary" style="text-align: center">Laporan Hasil Seleksi</h5>
    </div>
    <div class="table-responsive">
        <table id="resultdata" class="table table-striped table-bordered zero-configuration" style="border: 1">
            <thead>
                <tr align="center">
                    <th>No</th>
                    <th>Nama</th>
            ...
            <tbody>
                @foreach ($selectionresults as $sr)
                    <tr align="center">
                        ...
                        <td>{{ Carbon\Carbon::parse($sr->applicant->job->published_at)->format('d/m/Y') }}</td>
            ...
            $('#resultdata').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'PDF',
                        download: 'open',
                        messageTop: 'Berikut data hasil seleksi pelamar:',
