...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="/writtenattend">Laporan Kehadiran Seleksi Tertulis</a></li>
@endsection
...
@section('container')
    ...
    <ul class="nav nav-pills">
        <li><a href="/writtenattend" class="nav-link active">Tes Tertulis</a>
        </li>
    ...
    <div class="table-responsive">
        <table id="writtenattend" class="table table-striped table-bordered zero-configuration" style="border: 1">
            <thead>
                <tr align="center">
                    <th>No</th>
                    <th>Nama</th>
            ...
            $('#writtenattend').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'PDF',
                        download: 'open',
                        messageTop: 'Berikut data kehadiran seleksi tertulis:',
