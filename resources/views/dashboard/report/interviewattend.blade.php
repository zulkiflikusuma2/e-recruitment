...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="/interviewattend">Laporan Kehadiran Seleksi Wawancara</a></li>
@endsection
...
@section('container')
    ...
    <ul class="nav nav-pills">
        ...
        <li><a href="/practiceattend" class="nav-link">Tes Praktik</a>
        </li>
        <li><a href="/interviewattend" class="nav-link active">Wawancara</a>
        </li>
        <li><a href="/resultattend" class="nav-link">Agenda Penerimaan</a>
        </li>
    </ul>

    <div class="table-responsive">
        <table id="interviewattend" class="table table-striped table-bordered zero-configuration" style="border: 1">
            <thead>
                <tr align="center">
                    <th>No</th>
                    <th>Nama</th>
            ...
            $('#interviewattend').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'PDF',
                        download: 'open',
                        messageTop: 'Berikut data kehadiran seleksi wawancara:',
