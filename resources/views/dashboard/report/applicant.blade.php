...
@section('title', 'Report Applicants| CBI')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
    <li class="breadcrumb-item active"><a href="/activevacancies/">Laporan Pelamar</a></li>
@endsection

@section('container')

    <!-- DataTables Kategori Pelamar -->
    <div class="card-header">
        <h5 class="m-0 font-weight-bold text-primary" style="text-align: center">Laporan Pelamar</h5>
    </div>
    <div class="table-responsive">
        <table id="applicantsdata" class="table table-striped table-bordered zero-configuration" style="border: 1">
            <thead>
                <tr align="center">
                    <th>No</th>
                    <th>Nama</th>
            ...
            <tbody>
                @foreach ($applicants as $applicant)
                    <tr align="center">
                        ...
                        <td>{{ Carbon\Carbon::parse($applicant->job->published_at)->format('d/m/Y') }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
            ...
            $('#applicantsdata').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'PDF',
                        download: 'open',
                        messageTop: 'Berikut data pelamar yang mengajukan lamaran melalui website:',
