<div class="modal fade modalshowapproval" id="modalshowapproval{{$job->slug}}">
    <div class="modal-dialog modal-lg">
        <form action="/submissionsapproval/{{$job->slug}}" method="post" class="d-inline">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/submissionsapproval/{{ $job->slug }}/edit" class="btn btn-warning" data-toggle="modal" data-target="#modaleditapproval{{$job->slug}}">Persetujuan</a>
                </div>
            </div>
        </form>
    </div>
