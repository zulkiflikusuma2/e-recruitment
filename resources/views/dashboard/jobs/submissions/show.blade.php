<div class="modal fade modalshow" id="modalshow{{$job->slug}}">
    <div class="modal-dialog modal-lg">
        <form action="/submissions/{{$job->slug}}" method="post" class="d-inline">
            <div class="modal-content">
                ...
                <div class="modal-body text-justify" >
                    ...
                    <div class="form-group row">
                        <label class="col-lg-12 col-form-label"> Status : @if ($job->approval == '1') Disetujui @elseif ($job->approval == '0') Revisi @else Menunggu @endif <br>
                        Keterangan : {{ $job->description }}</label>
