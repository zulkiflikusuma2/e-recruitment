<div class="modal fade" id="modaledit{{$job->slug}}">
    <div class="modal-dialog modal-lg">
        <form action="/submissions/{{ $job->slug }}" method="post" class="mb-5" enctype="multipart/form-data" class="d-inline">
            @method('put')
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ubah Pengajuan {{ $job->position }}</h5>
                ...
                <div class="modal-body">
                    ...
                    @enderror
                    {{-- <input id="requirementedit" type="hidden" name="requirement" value="{{ old('requirement', $job->requirement) }}">
                    <trix-editor input="requirementedit"></trix-editor> --}}
