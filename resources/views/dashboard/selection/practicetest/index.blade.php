...
@section('title', 'Tes Praktik | CBI')
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="/dashboard">Dashboard</a>
    </li>
    <li class="breadcrumb-item"><a href="/practicetest">Tahap Seleksi Praktik</a></li>
@endsection
...
@section('container')
    ...
    <ul class="nav nav-pills">
        ...
        <li><a href="/practicetest" class="nav-link active">Tes Praktik</a>
        </li>
    ...
    <form action="" method="post" class="d-inline">
        @method('patch')
        @csrf
        @include('dashboard.selection.practicetest.confirm')
        @include('dashboard.selection.practicetest.announ')
                    ...
                    @if ($applicants->count())
                        @foreach ($applicants as $applicant)
                            <tr align="center">
                                ...
                                {{-- <td>{{ $applicant->written_test->score }}</td> --}}
                                ...
                                <td>
                                    <a href="/practicetest/{{ $applicant->id }}" class="btn btn-info" data-toggle="modal"
                                        data-target="#modalshow{{ $applicant->id }}"><i class="fas fa-eye"></i></a>
                                    <a href="/practicetest/{{ $applicant->id }}/edit" class="btn btn-warning"
                                        data-toggle="modal" data-target="#modaledit{{ $applicant->id }}"><i
                                            class="fas fa-plus"></i></a>
                                    {{-- <a href="/practicetest/{{ $applicant->id }}" class="btn btn-danger"  data-toggle="modal" data-target="#modaldelete{{ $applicant->id }}"><i class="fas fa-trash"></i></a> --}}
                                </td>
                            </tr>
    </form>
    @include('dashboard.selection.practicetest.delete')
    @include('dashboard.selection.practicetest.edit')
    @include('dashboard.selection.practicetest.show')
    @endforeach
    @endif
    </tbody>
    </table>
