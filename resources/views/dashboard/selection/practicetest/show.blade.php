        ...
        <form action="/administration/{{$applicant->id}}" method="post" class="d-inline">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="col-lg-9">:  {{ $applicant->written_test->score}}</label> <br>
                    <label class="col-lg-3 col-form-label" for="name">Status</label>
                    <label for="col-lg-9">:  @if ($applicant->written_test->status == '1') Memenuhi @elseif($applicant->written_test->status == '0') Tidak Memenuhi @else @endif</label> <br>
                    <label class="col-lg-3 col-form-label" for="name">Hasil Seleksi Praktik</label> <br>
                    <label class="col-lg-3 col-form-label" for="name">Skor</label>
                    <label for="col-lg-9">:  {{ $applicant->score}}</label> <br>
                    <label class="col-lg-3 col-form-label" for="name">Status</label>
                    <label for="col-lg-9">:  @if ($applicant->status == '1') Memenuhi @elseif($applicant->status == '0') Tidak Memenuhi @else @endif</label><br><br> <br><br>
