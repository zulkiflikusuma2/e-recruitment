...
<body>
    ...
    <div class="row g-0 flex-fill px-1 py-1 mb-auto pb-3">
                ...
                <div class="container  text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="http://cbi-astra.com/acknowledge-certificate/" class="text-white">Certification
                                    Recognition</a>
                            </p>
                        </div>
                        <!-- Grid column -->
